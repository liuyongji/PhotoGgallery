 ...
 *******************************************************************************/
package com.weedong.corps.framwork.view.pulltorefresh;
...
import com.weedong.corps.framwork.view.pulltorefresh.internal.FlipLoadingLayout;
import com.weedong.corps.framwork.view.pulltorefresh.internal.LoadingLayout;
import com.weedong.corps.framwork.view.pulltorefresh.internal.RotateLoadingLayout;
import com.weedong.corps.framwork.view.pulltorefresh.internal.Utils;
import com.weedong.corps.framwork.view.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
			...
			if (isReadyForPull()) {
				...
				if (absDiff > mTouchSlop
					...
					if (mMode.showHeaderLoadingLayout() && diff >= 1f
						...
						if (mMode == Mode.BOTH || mMode == Mode.BOTH_BUT_MORE) {
	...
	protected LoadingLayoutProxy createLoadingLayoutProxy(
		...
		if (includeEnd && mMode.showFooterLoadingLayout()) {
			proxy.setMoreLayout(mFooterLayout);
	...
	protected void updateUIForMode() {
		...
		// set it to pull down
		mCurrentMode = (mMode != Mode.BOTH || mMode != Mode.BOTH_BUT_MORE) ? mMode
	...
	public static enum Mode {
		...
		public boolean showFooterLoadingLayout() {
			return this == PULL_FROM_END || this == BOTH
					|| this == MANUAL_REFRESH_ONLY || this == BOTH_BUT_MORE;
		}
